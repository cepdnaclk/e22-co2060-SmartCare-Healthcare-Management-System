...
export default function Navbar() {
  ...
  return (
    <nav className="relative flex justify-between items-center px-6 md:px-12 py-4 bg-[#a1e2e8] shadow-sm md:pl-40 md:pr-40 z-50">
      ...
      <div className="hidden md:flex items-center">
        {isLoggedIn ? (
          <button
            ...
            className="flex items-center gap-2 bg-white text-red-600 px-5 py-2 rounded-none font-bold text-xl shadow-sm hover:bg-red-50 transition border-2 border-red-100"
          >
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="flex items-center gap-2 bg-white text-slate-800 px-5 py-2 rounded-none font-semibold text-xl shadow-sm hover:bg-slate-50 transition "
            >
